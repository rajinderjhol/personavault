...
// Constants
const DEFAULT_API_ENDPOINT = "/api"; // Use relative path to avoid CORS issues
...
export default class SettingsWidget {
    ...
    async fetchModels() {
        try {
            const response = await fetch(`${this.apiEndpoint}/ollama/models`, {
    ...
    async sendChatMessage(payload) {
        try {
            const response = await fetch(`${this.apiEndpoint}/ollama/chat`, {
                method: 'POST',
                headers: {
    ...
    async fetchModelDetails(modelName) {
        try {
            const response = await fetch(`${this.apiEndpoint}/ollama/models/${modelName}`, {
                credentials: 'include', // Include credentials (cookies)
            });
            if (!response.ok) {
                throw new Error(`HTTP error! Status: ${response.status}`);
    ...
    toggleDeploymentType(type) {
        ...
        if (type === 'local') {
            ...
            modelDropdownContainer.classList
    ...
    async saveAISettings() {
        try {
            ...
            const response = await fetch(`${this.apiEndpoint}/ollama/settings`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
    ...
    async deleteAISettings(setting_id) {
        try {
            const response = await fetch(`${this.apiEndpoint}/ollama/settings/${setting_id}`, {
                method: 'DELETE',
                credentials: 'include', // Include credentials (cookies)
            });
    ...
    async fetchAndDisplayCurrentModel() {
        try {
            const response = await fetch(`${this.apiEndpoint}/ollama/settings/current`, {
                credentials: 'include', // Include credentials (cookies)
            });
            if (!response.ok) {
    ...
    async populatePastSettingsDropdown() {
        try {
            const response = await fetch(`${this.apiEndpoint}/ollama/settings/past`, {
                credentials: 'include', // Include credentials (cookies)
            });
